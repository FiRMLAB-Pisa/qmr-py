...
@click.command()
@click.option( '--inversion-times', nargs=0, required=True, help='MP2RAGE inversion times for the two volumes in [ms]')
@click.argument('inversion_times', nargs=2)
@click.option( '--tr-flash', nargs=0, required=True, help='FLASH readouts repetition time(s) [ms]')
@click.argument('tr_flash', nargs=-1)
...
@click.command()
@click.option( '--inversion-times', nargs=0, required=True, help='FLAWS inversion times for the two volumes in [ms]')
@click.argument('inversion_times', nargs=2)
@click.option( '--tr-flash', nargs=0, required=True, help='FLASH readouts repetition time(s) [ms]')
@click.argument('tr_flash', nargs=-1)
