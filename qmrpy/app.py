...
@click.option( '--save-dicom', default=True, show_default=True, help='save reconstructed map as DICOM')
@click.option( '--save-nifti', default=True, show_default=True, help='save reconstructed map as NiFTI')
def flaws_longitudinal_relaxation(inversion_times, flip_angles, tr_flash , input_path, beta, inversion_efficiency, output_path, save_dicom, save_nifti):
    """
    Reconstruct quantitative T1 maps from FLAWS data.
    """
    alg.flaws_longitudinal_relaxation(inversion_times, flip_angles, tr_flash, input_path, beta, inversion_efficiency, output_path, save_dicom, save_nifti)
